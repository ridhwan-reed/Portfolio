		...
		<div className="w-full py-8 md:py-0 bg-white dark:bg-gray-900 px-6 pt-16 sm:pt-0">
			<div className="space-y-8 text-center">
				...
				<div className="space-y-3">
					<h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Ridhwan Salahuddin</h1>
					<h2 className="text-lg md:text-xl text-gray-600 dark:text-gray-400">Software Developer Intern</h2>
					...
					Bridging strategy and software to solve everyday problems
					</p>
				</div>
				...
				<div className="space-y-4">
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<span className="text-sm text-gray-600 dark:text-gray-400">Toronto, ON, Canada</span>
					</div>

					{/* Social Links */}
					<div className="flex items-center justify-center space-x-4 pt-2">
						<a
							href="https://github.com/ridhwan-reed"
							target="_blank"
						...
						<a
							href="https://www.linkedin.com/in/ridhwan-salahuddin-a82626171/"
							target="_blank"
							rel="noopener noreferrer"
							className="p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
						>
